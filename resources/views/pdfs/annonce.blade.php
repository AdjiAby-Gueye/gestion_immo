...
<head>
    ...
    <title>PDF des Annonces {{date('d/m/Y')}}</title>
...
<body>
    ...
    <div style="font-size: 22px;font-weight: bold;text-align: center;margin: 30px 0 10px;text-transform: uppercase">
        <div style="font-weight: 500;font-size: 18px;float: left;">Liste des Annonces</div>
    </div>
    <br><br>
    ...
    <table class="table mb-20">
        ...
        @for ($i = 0; $i < count($data); $i++)>
            <tr class="tr">
                ...
                <td class="td">{{ $data[$i]["concernes"] == 'immeuble' ? "Concerne tous les appartements de l'immeuble" : "" }} {{ $data[$i]["concernes"] == 'appartement' ? $data[$i]["appartement"]->nom : "" ; }} {{ $data[$i]["concernes"] == 'marketing' ? "concerne marketing" : "" ; }} {{ $data[$i]["concernes"] == 'immeubles' ? "concerne tout les immeubles" : "" ; }} </td>
