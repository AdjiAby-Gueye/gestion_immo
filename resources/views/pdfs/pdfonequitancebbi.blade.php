...
<body>
    ...
    <div style="font-size: 20px;font-weight: bold;text-align: center;background: grey;padding: 15px 70px;">
        Quittance N° 20237166
    </div>
    <div style="font-size: 10px;font-weight: bold;text-align: left;border: 1px solid black;padding: 10px;width:40%;float: right;margin-top: 10px;">
        <p>1 000 010--- {{
        ...
        <p>Immeuble / Villa : 2020 ---
            {{$data[0]['contrat']['appartement']['immeuble'] ? $data[0]['contrat']['appartement']['immeuble']['adresse']  : ""}}
        </p>
        <p>DAKAR</p>
    </div>
    ...
    <div style="font-size: 16px;font-weight: bold;text-align: left;">
        LOYER DU {{$data[0]['datefacture_format']}} au {{$data[0]['date_echeance_format']}}
    </div>
    <table class="table mb-10">
        ...
        <tr class="tr">
            <td class="td" style="font-size: 20px;">TLV ( 0.02 ) </td>
            <td class="td" style="font-size: 20px;">{{$data[0]['contrat']['appartement']['tlv']?
            $data[0]['contrat']['appartement']['tlv'] : 0   
            }}</td>
            </td>
        </tr>
        <tr class="tr">
            <td class="td" style="font-size: 20px;">TOTAL </td>
            <td class="td" style="font-size: 20px;">{{$data[0]['contrat']['appartement']['tlv']? $data[0]['montantloyerbase_avenant']  + $data[0]['montantloyertom_avenant'] + $data[0]['contrat']['appartement']['tlv'] :  $data[0]['montantloyerbase_avenant']  + $data[0]['montantloyertom_avenant'] }}</td>
            </td>
        </tr>
    </table>
    ...
    <div style="font-size: 15px;text-align: left;font-weight: bold;">
        {{$data[0]['contrat']['appartement']['tlv']? $data[0]['montantloyerbase_avenant']  + $data[0]['montantloyertom_avenant'] + $data[0]['contrat']['appartement']['tlv'] :  $data[0]['montantloyerbase_avenant']  + $data[0]['montantloyertom_avenant'] }}
    </div>
