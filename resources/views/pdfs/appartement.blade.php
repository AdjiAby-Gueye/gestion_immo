...
<head>
    ...
    <title>PDF des appartements {{date('d/m/Y')}}</title>
...
<div style="font-size: 22px;font-weight: bold;text-align: center;margin: 30px 0 10px;text-transform: uppercase">
    <div style="font-weight: 500;font-size: 18px;float: left;">Liste des appartements</div>
</div>
<br><br>
<div>
    <table class="table mb-20">
        ...
        <tr class="tr">
            ...
            <td class="td">
                {{ $data[$i]["immeuble"] ? $data[$i]["immeuble"]["nom"] : "--" }}
            </td>
            <td class="td">
                {{ $data[$i]["niveau"] ?? "--"}}
            </td>
            <td class="td">
                {{ $data[$i]["typeappartement"] ? $data[$i]["typeappartement"]["designation"] : "--" }}
            </td>
            <td class="td">
                @if (isset($data[$i]["proprietaire"]))
            ...
            <td class="td">
                {{ $data[$i]["etatappartement"] ? $data[$i]["etatappartement"]["designation"] : "--" }}
            </td>
        </tr>
        @endfor
    </table>
