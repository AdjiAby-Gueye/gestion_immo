...
<head>
    ...
    <title>PDF des contratprestations {{date('d/m/Y')}}</title>
...
<body>
    ...
    <div style="font-size: 22px;font-weight: bold;text-align: center;margin: 30px 0 10px;text-transform: uppercase">
        <div style="font-weight: 500;font-size: 18px;float: left;">Liste des Contrats prestations</div>
    </div>
    <br><br>
    ...
    <table class="table mb-20">
        ...
        @for ($i = 0; $i < count($data); $i++)>
            <tr class="tr">
                ...
                <td class="td">{{ $data[$i]["categorieprestation"]->designation}}</td>
