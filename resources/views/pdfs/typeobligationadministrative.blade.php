...
<head>
    ...
    <title>PDF type d'obligations administratives {{date('d/m/Y')}}</title>
...
<div style="font-size: 22px;font-weight: bold;text-align: center;margin: 30px 0 10px;text-transform: uppercase">
    <div style="font-weight: 500;font-size: 18px;float: left;">Liste des types d'obligations administratives </div>
</div>
<br><br>
