...
<head>
    ...
    <title>PDF des proprietaires {{date('d/m/Y')}}</title>
...
<div style="font-size: 22px;font-weight: bold;text-align: center;margin: 30px 0 10px;text-transform: uppercase">
    <div style="font-weight: 500;font-size: 18px;float: left;">Liste des proprietaires</div>
</div>
<br><br>
...
<div>
    <table class="table mb-20">
        <tr class="tr">
            ...
            <th class="whitespace-no-wrap text-center">Telephone portable</th>
        ...
        <tr class="tr">
            ...
            <td class="td"> {{$data[$i]["adresse"]}}</td>
            <td class="td"> {{$data[$i]["telephone"]}} </td>
            <td class="td"> {{$data[$i]["telephoneportable"]}} </td>
            <td class="td"> {{$data[$i]["telephonebureau"]}} </td>
        </tr>
        @endfor
    </table>
