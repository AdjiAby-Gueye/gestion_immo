...
<head>
    ...
    <title>APPEL ECHEANCE {{date('d/m/Y')}}</title>
...
<div style="font-size: 15px;font-weight: bold;text-align: center;margin: 30px 0 5px;text-transform: uppercase">
 ...
 <div style="font-size: 18px;font-weight: bold;text-align: center;margin: 10px 0 10px;">
 ...
 <div style="font-size: 15px;margin: 30px 0 5px;font-weight: bold;">
    ...
    <p style="text-align: center">
        ...
        @if ($data[0]['contrat']['montantloyer'])
         <x-nombre-en-lettre :nombre="$data[0]['contrat']['recap_amount_ridwan']"/> Francs CFA  ({{$data[0]['contrat']['recap_amount_ridwan_format']}})
        @else
        <i>no</i>
        @endif
    </p>
     ...
     <table class="table table-sm center" style="width:50%">
        ...
        <tbody>
            <tr>
                ...
                <td>{{ $data[0]['contrat']['montantloyerformat'] ? $data[0]['contrat']['montantloyerformat'] : "......................"}}</td>
                <td>F CFA</td>
            </tr>
            <tr>
                <td scope="row"> - Frais de gestion</td>
                <td>{{ $data[0]['contrat']['frais_gestion_format'] ? $data[0]['contrat']['frais_gestion_format'] : "......................"}}</td>
                <td>F CFA</td>
            </tr>
            ...
            <tr >
                ...
                <td style="border:  1px solid #000">
                    @if ($data[0]['contrat']['frais_gestion'] && $data[0]['contrat']['montantloyer'])
                        {{ $data[0]['contrat']['recap_amount_ridwan']  }}
                    @else
                       {{'....................'}}
                    @endif
                </td >
...
<div style="font-size: 13px;font-weight: bold;text-align: right;margin: -40% 0 10px;text-transform: uppercase">
    <p style="text-decoration:underline;">Le Secrétaire Général </p>
