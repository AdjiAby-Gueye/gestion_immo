...
<div class="footer " style="width: 100%; margin-bottom: 37%">
...
<body>
    ...
    <div>
        ...
        <div style="font-size: 15px;text-align: center;text-transform: uppercase">
            <p style="text-decoration:underline;font-weight: bold;;margin-top: 10%">
                Situation dépôt de garantie
            </p>
            <p> 
                @if($data[0]['locataire']['typelocataire']['designation']==="Physique")
                {{ $data[0]['locataire']['prenom'] }} {{ $data[0]['locataire']['nom'] }}
                @endif
                @if($data[0]['locataire']['typelocataire']['designation']!="Physique")
            ...
            <p>
                {{ $data[0]['appartement']['immeuble']['nom'] }} {{ $data[0]['appartement']['immeuble']['adresse'] }}
            </p>
        </div>
        <div style="font-size: 15px;text-align: left;margin: 60px 0 5px;">
            ...
            <table class="table mb-20" style="border: none">
                <tbody>
                        ...
                        <td style="border: none">
                            <i>
                                <span class="fa fa-underline"
                                    style="font-weight: bold;text-transform: uppercase;font-size: 20px;font-style: normal"
                                    aria-hidden="true"> Caution : </span>

                                <span style="font-size: 20px;font-style: normal">


                                    @foreach ($data[0]['locataire']['contrats'] as $contrat)
                                        @if ($contrat['appartement']['id'] === $data[0]['appartement']['id'])
                                            {{ $contrat['caution']['montantcaution'] }} F
                                        @endif
                                    @endforeach
                    ...
                    <tr style="margin-bottom: 40px">
                        ...
                        <td style="border: none; font-style: normal">
                            <i>
                                <span class="fa fa-underline"
                                    style="font-weight: bold;text-transform: uppercase;font-size: 20px;font-style: normal"
                                    aria-hidden="true"> Somme dues : </span>
                                <span>
                                    <span style="font-size: 20px; font-style: normal">
                                                {{  $data[0]['factureintervention']['montant_format'] }} F
                                                (traveaux de remise en etat de l'appartement)
                                    </span>
                                </span><br>

                                <span style="margin-left: 23%;font-size: 20px;font-style: normal">
                                    @foreach ($data[0]['locataire']['contrats'] as $contrat)
                                        @if (
                                            $contrat['appartement']['id'] == $data[0]['appartement_id'] &&
                                                $contrat['locataire']['id'] == $data[0]['locataire_id']
                                        )
                                            {{ $contrat['montant_dernier_facture_eau'] }} F
                                        @endif
                                    @endforeach
                                    (Facture d'eaux)
                                </span>
                    ...
                    <tr style="margin-bottom: 40px">
                        <td style="border: none"> <i>
                                <span class="fa fa-underline"
                                    style="font-weight: bold;text-transform: uppercase;font-size: 20px;font-style: normal"
                                    aria-hidden="true"> Somme a restituer :</span>
