...
<body>
    ...
    <div style="font-size: 13px;font-weight: bold;text-align: left;margin: 30px 0 10px;text-transform: uppercase">
        ...
        <p>
            Facture : {{( $data[0]['demandeintervention'] )? $data[0]['demandeintervention']['devi']['code'] :  $data[0]['etatlieu']['devi']['code'] }}
        </p>
        <p>
            Affaire : {{ ( $data[0]['demandeintervention'] )? $data[0]['demandeintervention']['devi']['object'] :  $data[0]['etatlieu']['devi']['object']}}
        </p>
    ...
    <div
        ...
        <p> {{ $data[0]['appartement']['nom'] }}
        </p>

        <p>

            {{ $data[0]['appartement']['immeuble']['adresse'] }}
    ...
    <div>
        ...
        <table class="table mb-20" style="border: none">
            ...
            <tbody style="border: 1.1px solid black ">
                ...
                @foreach ((( $data[0]['demandeintervention'])? $data[0]['demandeintervention'] ['devi']['detaildevis']: $data[0]['etatlieu'] ['devi']['detaildevis']) as $item)
                    <tr style="border: none ">
                        ...
                        <td style="border-top: 1px solid white;border-bottom: 1px solid white;">
                            <span class="titre-top-3">{{ $item['categorieintervention']['designation'] }}
                            </span> <br>
        ...
        <div style="font-size: 13px;font-weight: bold;text-align: left;margin: 10px 0 10px;">
            <p style="">Arrete a le present devis a la somme de
                {{ Outil::convertirEnLettres($montanttotalettc) }} francs CFA </p>
        </div>


        <!--Indiquer si la facture est  reglee -->
        @if ($data[0]['paiementintervention'])
            <div style="font-size: 13px;font-weight: bold;text-align: left;margin: 10px 0 10px;background-color: rgb(158, 240, 158);width: 250px;height: 50px; border-radius: 10px">
                <p style="text-align: center;margin-top: 10px;padding-top: 5%">facture reglée le {{$data[0]['paiementintervention']['date']}} par  {{$data[0]['paiementintervention']['modepaiement']['designation']}}</p>
            </div>
        @endif
