...
<body>
    ...
    <div style="font-size: 22px;font-weight: bold;text-align: center;margin: 30px 0 10px;text-transform: uppercase">
        <div style="font-weight: 500;font-size: 18px;float: left;">Liste des Contrats</div>
    </div>
    <br><br>
    ...
    <table class="table mb-20">
        ...
        @for ($i = 0; $i < count($data); $i++)>
            <tr class="tr">
                ...
                @if (isset($data[$i]["locataire"]['nomentreprise']))
                    <td class="td">{{ $data[$i]["locataire"]['nomentreprise'] }} </td>
                    @else
                        @if (isset($data[$i]["locataire"]['nom']))
                ...
                @if (isset($data[$i]["appartement"]['immeuble']))
                    <td class="td">{{ $data[$i]["appartement"]['immeuble']['adresse'] }}</td>
                @else
                    <td class="td"> -- </td>
                @endif

                <td class="td">{{ $data[$i]["montantloyerformat"]}}</td>
