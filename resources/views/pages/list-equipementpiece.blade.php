@if(auth()->user()->can('liste-equipementpiece') || auth()->user()->can('modification-equipementpiece') || auth()->user()->can('suppression-equipementpiece'))
        ...
        <div class="col-span-12 mt-6">
            ...
            <div class="sm:flex  items-center">
                ...
                <div class="intro-y block sm:flex  flex-1 items-center theme-dark border-raduis-right">
                    <h2 class="text-lg font-medium truncate mr-5 uppercase ml-2">
                        @{{titlePage}}
                        <span class="inline-block bg-white text-theme-106 ml-2 px-3 rounded-full">@{{paginations['equipementpiece'].totalItems}}</span>
                    </h2>
                    <div class="flex items-center sm:ml-auto mt-3 sm:mt-0">
                        @if(auth()->user()->can('creation-equipementpiece'))
                                ...
                                <div class="dropdown relative">
                                    ...
                                    <div class="dropdown-box mt-40 absolute left-1/2 transform  top-20 z-50 " style="width: 140px">
                                        <div class="dropdown-box__content box  p-2">
                                            <button class="button dropdown-box-btn   flex items-center text-gray-700" ng-click="showModalAdd('equipementpiece')" title="Ajouter"> Un Element</button>
                                            <button class="button dropdown-box-btn flex items-center text-gray-700" ng-click="showModalAdd('equipementpiece', {is_file_excel:true, title: 'equipementpiece'})" title="Import"> Fichier Excel</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="overflow-table">
                <div class="intro-y overflow-auto lg:overflow-visible mt-8 sm:mt-0">
                    <table class="table table-report sm:mt-2">
                        ...
                        <tbody>
                            <tr class="intro-x" ng-repeat="item in dataPage['equipementpieces']">
                                <td>
                                    <div class="font-medium whitespace-no-wrap">@{{ item.designation }}</div>
                                </td>
                                <td ng-if="item.generale == '0'">
                                    <div class="font-medium whitespace-no-wrap text-center">Particulier</div>
                                </td>
                                <td ng-if="item.generale == '1'">
                                    <div class="font-medium whitespace-no-wrap text-center">Générale</div>
                                </td>
                                ...
                                <td class="table-report__action w-56">
                                    <nav class="menu-leftToRight uk-flex text-center">
                                        ...
                                        <button class="menu-item btn border-0 bg-danger text-white fsize-16" ng-click="deleteElement('equipementpiece',item.id)" title="Supprimer">
                                            <span class="fa fa-trash-alt"></span>
                                        </button>
                                        <button class="menu-item btn border-0 bg-info text-white fsize-16" ng-click="showModalUpdate('equipementpiece',item.id)" title="Modifier les infos">
            ...
            <div class="col-span-12 grid grid-cols-12 gap-4 mt-3">
                <div class="col-span-12 sm:col-span-12 md:col-span-3">
                    ...
                    <select class="w-20 input box mt-1" ng-model="paginations['equipementpiece'].entryLimit" ng-change="pageChanged('equipementpiece')">
                ...
                <div class="col-span-12 sm:col-span-12 md:col-span-9" style="float:right">
                    <nav aria-label="Page navigation">
                        <ul class="uk-pagination float-right" uib-pagination total-items="paginations['equipementpiece'].totalItems" ng-model="paginations['equipementpiece'].currentPage" max-size="paginations['equipementpiece'].maxSize" items-per-page="paginations['equipementpiece'].entryLimit" ng-change="pageChanged('equipementpiece')" previous-text="‹" next-text="›" first-text="«" last-text="»" boundary-link-numbers="true" rotate="false"></ul>
                    </nav>
                </div>
            </div>
            <!-- /PAGINATION -->
