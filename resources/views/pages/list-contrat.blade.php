                                            ...
                                            <div class="dropdown relative">
                                                ...
                                                <div class="dropdown-box mt-40 absolute left-1/2 transform top-20 z-50" style="width: 140px">
                                                    <div class="dropdown-box__content box p-2">
                                                        <button class="button dropdown-box-btn flex items-center text-gray-700" ng-click="showModalAdd('contrat')" title="Ajouter">
                                                            Un Element
                                                        </button>
                                                        <button class="button dropdown-box-btn flex items-center text-gray-700" ng-click="showModalAdd('contrat', {is_file_excel:true, title: 'contrat'})" title="Import">
                                                            Fichier Excel
                                                        </button>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="flex flex-wrap -mx-3">
                                                                <div class="w-full md:w-1/2 px-3 mb-2">
                                                                    <div class="inline-block relative w-full">
                                                                        <select class="block appearance-none w-full bg-white text-gray-700 border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" id="searchoption_list_contrat" name="searchoption">
                                                                            <option value="">Rechercher par</option>
                                                                            <option selected value="descriptif">Descriptif</option>
                                                                            <option value="montantloyer">Montant loyer</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="w-full md:w-1/2 px-3 mb-2">
                                                                ...
                                                                <div class="w-full md:w-1/2 px-3 mb-2">
                                                                    <div class="inline-block relative w-full">
                                                                        <select class="select2 block appearance-none w-full bg-white text-gray-700 border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" id="locataire_list_contrat">
                                                                ...
                                                                <div class="w-full md:w-1/2 px-3 mb-2">
                                                                    <div class="inline-block relative w-full">
                                                                        <select class="select2 block appearance-none w-full bg-white text-gray-700 border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" id="appartement_list_contrat">
                                                                ...
                                                                <div class="w-full md:w-1/1 px-3 md:mb-0 mt-3">
                                                                    <div class="flex flex-wrap -mx-3">
                                                                        <div class="w-full md:w-1/2 px-3 md:mb-0">
                                                                            <a ng-if="filters" href="generate-pdf-contrat/@{{filters}}" target="_blank" class="custom-btn rounded-full small bg-danger mr-1 btn-shadow-dark" title="PDF">
                                                                                <span class="fas fa-file-pdf mr-1"></span>PDF
                                                                            </a>
                                                                            <a ng-if="!filters" href="generate-pdf-contrat" target="_blank" class="custom-btn rounded-full small bg-danger mr-1 btn-shadow-dark" title="PDF">
                                                                                <span class="fas fa-file-pdf mr-1"></span>PDF
                                                                            </a>
                                                                            <a ng-if="filters" href="generate-excel-contrat/@{{filters}}" target="_blank" class="custom-btn rounded-full btn-shadow" title="Excel">
                                                                                <span class="fas fa-file-excel mr-2"></span>EXCEL
                                                                            </a>
                                                                            <a ng-if="!filters" href="generate-excel-contrat" target="_blank" class="custom-btn rounded-full btn-shadow" title="Excel">
                                                                                <span class="fas text-success fa-file-excel mr-2"></span>EXCEL
                                                                            </a>
                                                                        </div>
                                                                        <div class="w-full md:w-1/2 px-3 md:mb-0 text-right">
                                                                            <button type="button" class="custom-btn small border mr-1 btn-shadow-dark" ng-click="emptyform('contrat', true)">
                                                                                <span class="fa icon-i fa-filter mr-1"></span>Annuler
                                                                            </button>
                                                                            <button type="button" class="custom-btn bg-theme-101 btn-shadow" ng-click="pageChanged('contrat')">
                                ...
                                <table class="table table-report sm:mt-2">
                                    <thead class="rounded">
                                        <tr class="thead rounded">
                                            ...
                                            <th class="whitespace-no-wrap text-center">État</th>
                                        ...
                                        <tr class="intro-x" ng-repeat="item in dataPage['contrats'] ">
                                            ...
                                            <td class="table-report__action w-56">
                                                <nav class="menu-leftToRight uk-flex text-center">
                                                    <input type="checkbox" href="#" class="menu-open" name="menu-open" id="menu-open1contrat-@{{ item.id }}">
                                                    <label class="menu-open-button theme-sombre" for="menu-open1contrat-@{{ item.id }}">
                                                    ...
                                                    <button class="menu-item btn border-0 bg-primary text-white fsize-16" ng-click="showModalDetail('contrat',item.id)" title="Détails">
                                                    ...
                                                    <button class="menu-item btn border-0 bg-warning text-white fsize-16" ng-click="showModalStatut($event,'contrat',0, item, 'Résilier')" title="Résilier">
