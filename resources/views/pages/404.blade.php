        ...
        <div class="col-span-12 mt-6">
            <div class="intro-y block sm:flex items-center h-10">
                ...
                <div class="flex items-center sm:ml-auto mt-3 sm:mt-0">
                    ...
                    <button class="button box flex items-center text-gray-700" ng-click="showModalAdd('be')" title="Ajouter"> <i class="fa fa-plus mr-2"></i> Ajouter </button>
                </div>
            </div>
                                                ...
                                                <form class="bg-white grid p-3 mt-3">
                                                    <div class="flex flex-wrap -mx-3">
                                                        ...
                                                        <div class="w-full md:w-1/1 px-3 md:mb-0 text-right">
                                                            <button type="button" class="button small border text-gray-700 mr-1 btn-shadow-dark" ng-click="emptyform('be', true)"><span class="fa fa-filter mr-1"></span>Annuler</button>
                                                            <button type="button" class="button bg-theme-101 text-white btn-shadow" ng-click="pageChanged('be')"><span class="fa fa-search mr-1"></span>Filtrer</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                ...
                <div class="intro-y overflow-auto lg:overflow-visible">
                    <table class="table table-report">
                        ...
                        <tr>
                            ...
                            <th class="whitespace-no-wrap text-center">Entité</th>
                        ...
                        <tr class="intro-x" ng-repeat="item in dataPage['bes']">
                            ...
                            <td class="table-report__action w-56">
                                <nav class="menu-leftToRight uk-flex text-center">
                                    ...
                                    <button class="menu-item btn border-0 bg-danger text-white fsize-16" ng-click="deleteElement('be',item.id)"  title="Supprimer">
                                        <span class="fa fa-trash-alt"></span>
                                    </button>
                                    <button class="menu-item btn border-0 bg-info text-white fsize-16"  ng-click="showModalUpdate('be',item.id)" title="Modifier les infos">
                                        <span class="fal fa-edit"></span>
                                    </button>
                                    <button class="menu-item btn border-0 bg-dark text-white fsize-16" ng-click="showModalDetail('be',item.id)"  title="Voir les détails">
                                        <span class="fa fa-info"></span>
                                    </button>
                                    <a ng-if="item.facture != null" href="@{{item.facture}}" target="_blank" class="menu-item btn fsize-12 border-0 bg-warning text-white fsize-16" style="padding-top: 6px!important;" title="PDF BC JOINT">
