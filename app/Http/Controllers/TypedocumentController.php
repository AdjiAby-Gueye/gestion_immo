...
use App\Jobs\ImportTypedocumentFileJob;
...
class TypedocumentController extends SaveModelController
{
    //extends BaseController

    use AuthorizesRequests, DispatchesJobs, ValidatesRequests;

    protected $queryName = "typedocuments";
            ...
            return DB::transaction(function () use ($request) {
                ...
                if (isset($request->id)) {
                    if (is_numeric($request->id) == true) {
                        $item = Typedocument::find($request->id);
                ...
                } else if (!Outil::isUnique(['designation'], [$request->designation], $request->id, Typedocument::class)) {
