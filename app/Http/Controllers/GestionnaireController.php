...
use App\Jobs\ImportGestionnaireProprietaireFileJob;
...
class GestionnaireController extends SaveModelController
{
    ...
    protected $job = ImportGestionnaireProprietaireFileJob::class;
    //
