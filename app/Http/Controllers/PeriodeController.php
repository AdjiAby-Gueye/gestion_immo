...
class PeriodeController extends SaveModelController
{
    //
            ...
            return DB::transaction(function () use ($request) {
                ...
                if (isset($request->id)) {
                    if (is_numeric($request->id) == true) {
                        $item = Periode::find($request->id);

                        if (!$item) {
                            $retour = array(
                                "data" => null,
                                "error" => "La periode que vous tentez de modifier n'existe pas ",
                            );
                            return $retour;
                        }
                    } else {
                ...
                if (empty($request->designation)) {
                    ...
                    $errors = "Cette periode existe deja !";
                }
