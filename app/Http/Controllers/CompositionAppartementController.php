...
use App\Jobs\ImportCompositionAppartementFileJob;
use App\Jobs\ImportEquipementsAppartementFileJob;
use Illuminate\Routing\Controller as BaseController;
use Illuminate\Foundation\Validation\ValidatesRequests;
use Illuminate\Foundation\Auth\Access\AuthorizesRequests;
use App\{Appartement, Events\SendNotifEvent, Notif, NotifPermUser, Outil, Produit};

class CompositionAppartementController extends SaveModelController
{
    //
    ...
    protected $job = ImportCompositionAppartementFileJob::class;
