...
class CreatePieceEquipementObservationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('piece_equipement_observation', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('piece_equipement_observation');
    }
}
