...
class CreateImmeubleProprietaireTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('immeuble_proprietaire', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('immeuble_proprietaire');
    }
}
